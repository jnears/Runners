class Iadmin::PostsController < ApplicationController
  ...
  def update
    ...
    respond_to do |format|
      if @post.update(post_params) 
        format.html { redirect_to iadmin_posts_path, notice: 'post was successfully updated.' }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to iadmin_posts_path }
